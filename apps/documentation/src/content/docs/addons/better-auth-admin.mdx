...
3. ### Update the database
   ...
   For detailed instructions on database migrations and schema updates, check out the [Database Migrations explanation](/grocery/explanations/6_database-migrations).
   :::
