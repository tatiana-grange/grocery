...
:::note[Prerequisites]
This guide assumes you have already integrated the Organizations plugin. If you haven't, please follow the [Organizations integration guide](/grocery/addons/better-auth-orgs) first.
:::
...
3. ### Update the database
   ...
   For detailed instructions on database migrations and schema updates, check out the [Migrations explanation](/grocery/explanations/6_database-migrations).
   :::
