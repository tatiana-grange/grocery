...
There is no module generator. Build a new module by hand following the module structure
above, and use an existing feature module — `apps/api/src/modules/members/` or
`apps/api/src/modules/catalog/` — as the reference for entity, contract, mapper, service,
controller, module, and e2e test.
