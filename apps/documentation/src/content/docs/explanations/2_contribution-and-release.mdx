...
This page explains the reasoning behind our contribution and release system. The rules themselves live in [`CONTRIBUTING.md`](https://github.com/tatiana-grange/grocery/blob/main/CONTRIBUTING.md), and the mechanics (versions, releases, deployments) are described in [Release and versioning](/grocery/references/1_release_and_versionning).
