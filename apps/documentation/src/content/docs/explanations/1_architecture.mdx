...
After years using GraphQL, we went back to REST (you can find the reasoning in the [Network Architecture page](/grocery/explanations/4_network-architecture)), but we kept most benefits of GraphQL: full typing, documentation, caching, etc.
