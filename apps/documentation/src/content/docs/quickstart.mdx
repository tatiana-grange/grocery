...
After cloning the repository, follow these steps to get a local environment running.
...
For more details, check the [project's README.md](https://github.com/tatiana-grange/grocery/blob/main/README.md).
