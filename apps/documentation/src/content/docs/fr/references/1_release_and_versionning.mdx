...
Les règles d'écriture des commits et des pull requests vivent dans [`CONTRIBUTING.md`](https://github.com/tatiana-grange/grocery/blob/main/CONTRIBUTING.md). Pour comprendre pourquoi le système est conçu ainsi, lisez [Contribution et release](/grocery/fr/explanations/2_contribution-and-release).
...
- [`CHANGELOG.md`](https://github.com/tatiana-grange/grocery/blob/main/CHANGELOG.md) est l'inventaire généré : une ligne par changement, chacune liée à son commit. Ne l'éditez jamais à la main.
