...
5. **Update CHANGELOG.md**: After generating tasks, append an entry to `FEATURE_DIR/CHANGELOG.md`:
   ```markdown
   ## [YYYY-MM-DD HH:MM] - /speckit.tasks
   ### Added
   - Task list generated with [X] tasks across [Y] phases
   - User stories covered: [list US1, US2, etc.]
   - **Author**: AI (Claude)
   - **Files**: tasks.md
   ```

6. **Report**: Output path to generated tasks.md, changelog update, and summary:
   - Total task count
